...
const EN = {
  ...
  'Lag en push/pull/legs-split': 'Make a push/pull/legs split',
  'Upper/lower, 4 dager i uka': 'Upper/lower, 4 days a week',
  'Jeg vil begynne med mer cardio': 'I want to start doing more cardio',
  'Fullkropp 3x i uka': 'Full body 3x a week',
  '{n} økter': '{n} workouts',
  ...
  'Øktene dine havner i dagboka med ekte kalorier, og dagsbalansen bruker dem automatisk.':
      'Your workouts land in the diary with real calories, and the daily balance uses them automatically.',
  'Importerer …': 'Importing …',
  '📂 Velg CSV-fil': '📂 Choose CSV file',
  // Kroppsmodell (MusclePicker)
  '🧬 Bygg økt fra kroppen': '🧬 Build a workout from the body',
  'Velg kroppstype': 'Choose body type',
  'Gutt': 'Male',
  'Jente': 'Female',
  'Snu kroppen for å nå muskler på begge sider': 'Turn the body to reach muscles on both sides',
  'Rygg': 'Back',
  'Trykk på en muskel': 'Tap a muscle',
  'Fokus': 'Focus',
  'Styrke': 'Strength',
  'Volum': 'Volume',
  'tunge løft, ca. 5 reps per sett': 'heavy lifts, ~5 reps per set',
  'muskelvekst, ca. 10 reps per sett': 'muscle growth, ~10 reps per set',
  'Øvelser': 'Exercises',
  'Sett per øvelse': 'Sets per exercise',
  'Færre øvelser': 'Fewer exercises',
  'Flere øvelser': 'More exercises',
  'Færre sett': 'Fewer sets',
  'Flere sett': 'More sets',
  '⚡ Lag økt ({e} øvelser × {s} sett)': '⚡ Create workout ({e} exercises × {s} sets)',
  '✓ Lagt i økta under': '✓ Added to the workout below',
  'Musklene på baksiden/framsiden finner du under den andre knappen.':
      'The muscles on the other side are under the other button.',
  'Bryst': 'Chest',
  'Skuldre': 'Shoulders',
  'Mage': 'Core',
  'Lår (fremside)': 'Quads (front thigh)',
  'Nakke/trapes': 'Neck/traps',
  'Korsrygg': 'Lower back',
  'Setet': 'Glutes',
